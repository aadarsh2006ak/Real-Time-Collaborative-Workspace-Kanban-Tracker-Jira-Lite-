      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8">
          {status === 'loading' && projects.length === 0 ? (
            ...
            <div className="text-center py-20 bg-slate-900/40 rounded-2xl border border-slate-800/80 p-8 max-w-lg mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects.map((project) => (
                <Link
                  ...
                  className="group relative p-5 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-blue-500/50 hover:bg-slate-850/80 transition-all shadow-lg flex flex-col justify-between"
                >
                  <div>
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-400">
                    ...
                    <span className="text-blue-400 group-hover:translate-x-1 transition-transform flex items-center gap-1 font-semibold text-[11px]">
